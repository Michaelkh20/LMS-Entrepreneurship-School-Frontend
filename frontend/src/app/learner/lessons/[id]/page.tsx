...
export default function LessonPage({
  ...
  const lessonsData: lessonType = {
    lessonTitle: 'Ошибки при выводе продуктов на рынок',
    lessonDescription: `Об организации курса, формат работы
  ...
  return (
    <div className={styles.main__container}>
      <h1 className={styles.main__header}>Урок {id}</h1>
      <div>{lessonsData.lessonTitle}</div>
      {/* <div>{lessonsData.lessonDescription}</div> */}

      <ReactQuill value={textField} onChange={setTextField}></ReactQuill>
      ...
      >
        <h2>Материалы</h2>
        {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=Tv5JyQ7W1OEuiEkU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> */}
        {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=Tv5JyQ7W1OEuiEkU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> */}
        <div
          style={{
            display: 'flex',
        ...
        >
          <iframe
            ...
            src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=Tv5JyQ7W1OEuiEkU"
        ...
        <div>
          ...
          >
            <a style={{ display: 'flex', alignItems: 'center', gap: '.25rem' }}>
              <svg
                width="14"
                height="14"
                viewBox="0 0 10 12"
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <h2>Описание</h2>
        <div
          style={{ whiteSpace: 'pre', paddingLeft: '1rem', fontSize: '1rem' }}
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(lessonDescriptionHtml),
          }}
        />
      </div>
      ...
      {/* <div>{textField}</div> */}
      {/* <ReactQuill value={textField} onChange={setTextField} theme='bubble'></ReactQuill> */}
    </div>
  );
}
