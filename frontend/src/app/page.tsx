  ...
  return (
      <div className={styles.main}>
        ...
        <div className={styles.programComponents}>
          <div>
            ...
            <div className={styles.componentBlock}>
              ...
              <span description="">
                ...
                которого приобретает компетенции для создания и внедрения
                продукта на рынок.
              </span>
            </div>
          ...
          <div>
            ...
            <div className={styles.componentBlock}>
              ...
              <span description="">
                Участники тестирования на определение уровней развития
                необходимых hard и soft skills, после которых получают
                индивидуальные рекомендации по обучению
              </span>
            </div>
          ...
          <div>
            <div className={styles.componentBlock}>
              ...
              <span description="">
                ...
                бизнес-наставник, сопровождающий команду на всех этапах
                реализации стартапа.
              </span>
            </div>
          ...
          <div side="left">
            ...
            <div>
              ...
              <span>
                ...
                робототехники Координационного центра при Минкомсвязи,
                программный директор технологического фестиваля Digital Wave)
              </span>
            </div>
          </div>
          ...
          <div side="right">
            ...
            <div>
              ...
              <span>
                ...
                педагогике, робототехнике и использованию технологий в
                образовании
              </span>
            </div>
        ...
        <div className={styles.contest} smth="">
          <div>
            <span blue="">
              Международная олимпиада по экономике IEOx Winter Challenge (золото
              и бронза)
            </span>
            <span pink="">
              Идеатон для школьников Ideathon Junior (1 призер)
            </span>
          </div>
          ...
          <div>
            <span pink="">
              “Высший пилотаж” (19 призеров за 2021 - 22 гг, порядка 20
              финалистов каждый год)
            </span>
          ...
          <div>
            <span pink="">
              “Большая перемена” (победа и грант на 1 млн руб.)
            </span>
