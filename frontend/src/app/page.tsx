...
import { readMore } from './button.tsx';

export default function Home() {
  // let buttons = [false, false, false, false, false];

  // const handleButtonImage = (num: number) => {
  //   buttons[num - 1] = !buttons[num - 1];
  //   console.log(buttons[num - 1]);
  //   console.log(num - 1);
  //   readMore(num);
  // };
