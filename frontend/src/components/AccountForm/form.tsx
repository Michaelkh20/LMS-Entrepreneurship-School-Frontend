...
export default function EditForm({ isRegistrationForm }: EditFormProps) {
    ...
    return (
        <Form form={form} onFinish={onFinish} layout="vertical" style={{ padding: '3rem' }}>
            <Form.Item
                label="Имя"
                name="firstName"
            ...
            <Form.Item label="Мессенджер" name="messenger" labelCol={{ span: 6 }} wrapperCol={{ span: 4 }}>
                <Select>
            ...
            <Form.Item>
                <Space>
                    <Button type="primary" htmlType="submit" style={{ backgroundColor: '#198754', align: 'left' }}>
